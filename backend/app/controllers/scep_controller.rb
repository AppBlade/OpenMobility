class ScepController < ApplicationController
  ...
  ScepKey = OpenSSL::PKey::RSA.new File.read("/AppBlade/current/lib/ssl/production/scep.key")
  ScepCert = OpenSSL::X509::Certificate.new File.read("/AppBlade/current/lib/ssl/production/scep.crt")
  ...
  def pki_operation
    ...
    when MessageTypes['PKCSReq']
      ...
      raise ArgumentError unless device_registration.scep_challenge == challenge_password
      raise ArgumentError unless x509_request.verify(x509_request.public_key)
